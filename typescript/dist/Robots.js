...
const genLetter = () => _ALPHABET[Math.floor(Math.random() * 26)];
const genNumber = () => Math.floor(Math.random() * 10);
function nameGenerator(id = '') {
...
class Robot {
    ...
    resetName() {
        this.id = '';
        console.log(`robot's name has successfully been cleared! id-name property is:`, this.id);
    }
