...
Note that the intersection isdefined based on reference, not value
that is, if the kth node of the first linedlist is the exact same node as the jth node of the second linked list, then they are intersecting
